...
<div class="card border shadow-sm">
    <div class="card-body p-4">
        ...
        <form action="<?= site_url('transactions/store') ?>" method="post">
            ...
            <div class="mb-4">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="radio" class="btn-check" name="transaction_type" id="expense" value="expenses"
                            <?= old('transaction_type', 'expenses') === 'expenses' ? 'checked' : '' ?>>
