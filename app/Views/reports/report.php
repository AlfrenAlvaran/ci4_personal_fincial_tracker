...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        ...
        <p class="text-muted mb-0">Analyze your financial performance and spending habits</p>
    </div>
    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end">
            <li>
                <a class="dropdown-item" href="<?= site_url('reports/export') ?>?format=pdf&months=<?= $exportMonth ?>&category=<?= $exportCategory ?>&category_name=<?= esc($exportCatName) ?>">
                    <i class="bi bi-file-earmark-pdf me-2 text-danger"></i>Export as PDF
                </a>
            </li>
            <li>
                <a class="dropdown-item" href="<?= site_url('reports/export') ?>?format=xlsx&months=<?= $exportMonth ?>&category=<?= $exportCategory ?>&category_name=<?= esc($exportCatName) ?>">
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card border h-100">
            <div class="card-body">
                ...
                <h3 class="fw-bold text-success mt-2">₱<?= number_format($summary['totalIncome'] ?? 0, 2) ?></h3>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card border h-100">
            <div class="card-body">
                ...
                <h3 class="fw-bold text-danger mt-2">₱<?= number_format($summary['totalExpenses'] ?? 0, 2) ?></h3>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card border h-100">
            <div class="card-body">
                ...
                <h3 class="fw-bold text-primary mt-2">₱<?= number_format($summary['netSavings'] ?? 0, 2) ?></h3>
            </div>
        </div>
    </div>
...
<div class="row g-4 mt-1">
    ...
    <div class="col-lg-8">
        <div class="card border">
            <div class="card-body">
                <h5 class="fw-semibold mb-4">Income vs Expenses</h5>
    ...
    <div class="col-lg-4">
        <div class="card border">
            <div class="card-body">
                <h5 class="fw-semibold mb-4">Spending by Category</h5>
                <div style="height:350px;">
...
<div class="card border mt-4">
    <div class="card-body">
        <h5 class="fw-semibold mb-4">Top Spending Categories</h5>
